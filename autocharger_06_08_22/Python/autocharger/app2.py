...
def Port():
        ...
        try:
            ...
            client.publish(serTopic1,str(data1))
            client.publish(serTopic2,str(data2)) 
            ...
            all1 = ("CHG1"+","+rd1 +","+amp1+","+volt1+","+alerm1) 
            all2 = ("CHG2"+","+rd2 +","+amp2+","+volt2+","+alerm2)       
...
def main():
    while _break == 0:
        ...
        if milliseconds - last_millis > 200:
            Port()
